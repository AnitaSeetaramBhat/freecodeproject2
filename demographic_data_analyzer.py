...
def calculate_demographic_data(print_data=True):
   ...
   df[lower_education].shape[0]) * 100, 1
    ...
    # What is the minimum number of hours a person works per week?df = pd.read_csv('adult.data.csv', header=None, names=[
    ...
    highest_earning_country_percentage = round((countries / countries_total).max() * 100, 1)
